...
<head>
    ...
    <meta charset="UTF-8">
    <title><?php echo isset($title) ? $title : "Jewelry Shop"; ?></title>
                ...
                <div class="row" style="align-items: center; display: flex;">
                    ...
                    <div class="col-xs-12 col-sm-3 text-center" style="display: flex; align-items: center; justify-content: center;">
                        <a href="index.htm" class="logo" title="Fashion Store">
                            <img src="Uploads/shop2198/images/logo2.png" alt="Fashion Store" style="max-height: 70px;">
                        </a>
                    </div>
                    <!-- Search box -->
                    ...
                    <div id="trademark-box" class="row">
                        <div class="col-sm-12">
                            <ul id="trademark-list">
                                ...
                                <li><a href="javascript:;"><img src="../assets/img/trademark_1.jpg?v=42" alt="Phương thức thanh toán 1"></a></li>
                                <li><a href="javascript:;"><img src="../assets/img/trademark_2.jpg?v=42" alt="Phương thức thanh toán 2"></a></li>
                                <li><a href="javascript:;"><img src="../assets/img/trademark_3.jpg?v=42" alt="Phương thức thanh toán 3"></a></li>
                                <li><a href="javascript:;"><img src="../assets/img/trademark_4.jpg?v=42" alt="Phương thức thanh toán 4"></a></li>
                                <li><a href="javascript:;"><img src="../assets/img/trademark_5.jpg?v=42" alt="Phương thức thanh toán 5"></a></li>
                                <li><a href="javascript:;"><img src="../assets/img/trademark_6.jpg?v=42" alt="Phương thức thanh toán 6"></a></li>
                                <li><a href="javascript:;"><img src="../assets/img/trademark_7.jpg?v=42" alt="Phương thức thanh toán 7"></a></li>
                                <li><a href="javascript:;"><img src="../assets/img/trademark_8.jpg?v=42" alt="Phương thức thanh toán 8"></a></li>
                                <li><a href="javascript:;"><img src="../assets/img/trademark_9.jpg?v=42" alt="Phương thức thanh toán 9"></a></li>
                                <li><a href="javascript:;"><img src="../assets/img/trademark_10.jpg?v=42" alt="Phương thức thanh toán 10"></a></li>
                            </ul>
                        </div>
                    </div> <!-- /#trademark-box -->
