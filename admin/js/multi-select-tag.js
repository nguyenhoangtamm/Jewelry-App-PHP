function MultiSelectTag (el, customs = {shadow: false, rounded:true}) {
    ...
    function init() {
        ...
        const modalAddContainerTag = document.querySelector('.js-modal-addBook-container')
        ...
        const modalChangeContainerTag = document.querySelector('.js-modal-changeBook-container')
